                        ...
                        <div className="flex items-start gap-1.5">
                          ...
                          <div className="min-w-0">
                            ...
                            {post.community_post_products?.length > 0 && (
                              <span className="text-[10px] text-purple-400/60 truncate block mt-0.5">
            ...
            {totalPages > 1 && (
              <div className="flex justify-center gap-1 mt-5">
                <button disabled={page === 1} onClick={() => setPage(1)}
                  className="px-2.5 py-1.5 text-xs bg-surface border border-border rounded-lg text-white/35 hover:text-white disabled:opacity-30 transition-colors">
                  «
                </button>
